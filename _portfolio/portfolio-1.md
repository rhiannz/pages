...
<center><img src="/images/od_Fig2.png" width="700"></center><br>
&emsp; Figure 2. Visualizing Missing Data in Final Dataset (2011-2020) <br>
&emsp; Note: The figure above details the missing values of our data frame after merging our covariates with all U.S. counties. Black represents the available data. White represents the missing values. 31420 indicates the number of rows in our overall data frame. </p>


<p style="line-height:1.2;margin-bottom:0;">
<p style="text-align:center;"><img src="/images/od_Tab1.png" class="center" width="700"></p>
&emsp; Table 1. OLS Regression Results of Baseline Model </p>
...
<p style="color:silver;font-weight:200;font-size:13px;line-height:2"> 
